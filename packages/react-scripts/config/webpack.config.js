  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // mmenard-react-scripts BEGIN : allow imports without relative paths
        AppSrc: paths.appSrc,
    ...
    module: {
      ...
      rules: [
        ...
        // mmenard-react-scripts BEGIN
        // NEW: FB introduced tslint in V3
        // however they lint the js and ts files together with their eslint config
        // this means their eslint config can only use rules compatible with tslint and needs a TS adapter in it
        // instead we continue linting js and ts files with separate eslint and tslint configs as before
        {
          test: /\.(js|mjs|jsx)$/,
          enforce: 'pre',
          use: [
            {
              options: {
                // enable .eslintrc config file in app
        ...
        // mmenard-react-scripts BEGIN : add tslint linter as pre-loader with same config as eslint
        {
          test: /\.(ts|tsx)$/,
          enforce: 'pre',
          use: [
